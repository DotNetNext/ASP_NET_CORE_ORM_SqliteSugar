...
namespace SQLiteSugar
{
    ...
    public partial class SqlSugarTool
    {
        ...
        public static void SetParSize(SqliteParameter par)
        {
            int size = par.Size;
            if (size < 4000)
            {
        ...
        /// <returns></returns>
        public static SqliteParameter[] GetParameters(object obj, PropertyInfo[] pis = null)
        {
            ...
            if (obj != null)
            {
                ...
                if (isDic)
                {
                    if (type == SqlSugarTool.DicArraySO)
                    {
                        ...
                        var pars = newObj.Select(it => new SqliteParameter("@" + it.Key, it.Value));
                ...
                else
                {
                    ...
                    foreach (PropertyInfo r in propertiesObj)
                    {
                        ...
                        {
                            var par = new SqliteParameter("@" + r.Name, value);
                            SetParSize(par);
                            listParams.Add(par);
                        }
                    }
