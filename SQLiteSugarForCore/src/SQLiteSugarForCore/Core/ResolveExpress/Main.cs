...
namespace SQLiteSugar
{
    ...
    internal partial class ResolveExpress
    {
        ...
        public List<SqliteParameter> Paras = new List<SqliteParameter>();
        ...
        private string AddParas(ref string left, object right)
        {
            ...
            if (right == null)
            {
                this.Paras.Add(new SqliteParameter(SqlSugarTool.ParSymbol + left, DBNull.Value));
            }
            else
            {
                this.Paras.Add(new SqliteParameter(SqlSugarTool.ParSymbol + left, right));
            }
            return oldLeft;
        }
        ...
        private string AddParasReturnRight(object left, ref string right)
        {
            ...
            if (left == null)
            {
                this.Paras.Add(new SqliteParameter(SqlSugarTool.ParSymbol + right, DBNull.Value));
            }
            else
            {
                this.Paras.Add(new SqliteParameter(SqlSugarTool.ParSymbol + right, left));
            }
            return oldRight;
        }
